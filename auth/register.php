	...
	if (empty($errMsg)) {
		try {
			...
			if ($stmt->rowCount() > 0) {
				...
				$sql = "INSERT INTO users (name, email, password, occupation, state, lga, phone, language, uid) VALUES (:name, :email, :password, :occupation, :state, :lga, :phone, :language, :uid)";
